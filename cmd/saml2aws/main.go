...
func main() {
	...
	cmdLogin.Flag("auto-fill", "Skips manual input by auto-filling prompts from flags, config, env vars, and OS credential manager (e.g., macOS Keychain, Windows Credential Manager).").BoolVar(&loginFlags.AutoFill)
